...
{	
	...
	//Propose au joueur, si il était déja registered et qu'il ne s'est pas encore connecté a facebook, de connecter le jeu à FaceBook
	doYouWantToConnectToFacebook();
